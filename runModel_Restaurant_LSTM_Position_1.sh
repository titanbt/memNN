...
#PBS -q SINGLE
#PBS -o /home/s1620007/deepNN_java/outputs/deepNN_Res_LSTM_pos_1.out
#PBS -e /home/s1620007/deepNN_java/outputs/deepNN_Res_LSTM_pos_1.in
#PBS -N deepNN_Res_LSTM_pos_1
#PBS -j oe
...
java -Xmx8g -cp $root model.LSTM_EntityMemNNMain_Position_1 \
-embeddingLength 300 \
-roundNum 300 \
-classNum 3 \
