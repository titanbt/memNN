...
public class Bi_LSTM_EntityMemNNMain {
	...
	public Bi_LSTM_EntityMemNNMain(String modelFile) throws Exception
	{
	...
	public Bi_LSTM_EntityMemNNMain() throws Exception
	{
...
//		System.out.println("The best accuracy:" + String.format("%.4f", bestAcc) + " - Model file:" + bestModelFile);
		...
		Bi_LSTM_EntityMemNNMain main = new Bi_LSTM_EntityMemNNMain(modelFile);
