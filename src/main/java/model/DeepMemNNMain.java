...
public class DeepMemNNMain {
	...
	public DeepMemNNMain(String modelFile) throws Exception
	{
	...
	public DeepMemNNMain() throws Exception
	{
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
			...
			SentenceDeepMemNN memNN = new SentenceDeepMemNN(
					wordIds,
					seedLookup,
					attentionCellSeed,
					entityTranformSeed,
...
//		writer.close();
	...
	public void dumpAttentionWeights(SentenceDeepMemNN memNN,
	...
	public static void main(String[] args) throws Exception
	{
		...
		DeepMemNNMain main = new DeepMemNNMain();
