...
import nn.LSTM_SentenceEntityMemNN_LinearTanh;
...
public class LSTM_EntityMemNNMain_LinearTanh {

	LookupLayer seedLookup;
	ConnectLinearTanh attentionCellSeed;
	LinearTanh entityTranformSeed;
	...
	public LSTM_EntityMemNNMain_LinearTanh(String modelFile) throws Exception
	{
	...
	public LSTM_EntityMemNNMain_LinearTanh() throws Exception
	{
		...
		entityTranformSeed = new LinearTanh(embeddingLength, embeddingLength);
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
			...
			LSTM_SentenceEntityMemNN_LinearTanh memNN = new LSTM_SentenceEntityMemNN_LinearTanh(
					wordIds,
					seedLookup,
					attentionCellSeed,
					entityTranformSeed,
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
	...
	class TmpClass_{
		...
		LinearTanh _entityTranformSeed;
		...
		public TmpClass_(BufferedReader br) throws Exception
		{
			...
			_entityTranformSeed = LinearTanh.loadFromStream(br);
	...
	public void dumpAttentionWeights(LSTM_SentenceEntityMemNN_LinearTanh memNN,
	...
	public static void main(String[] args) throws Exception
	{
		...
		LSTM_EntityMemNNMain_LinearTanh main = new LSTM_EntityMemNNMain_LinearTanh();
