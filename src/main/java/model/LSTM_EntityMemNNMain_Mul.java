...
import nn.LSTM_SentenceEntityMemNN_Mul;
...
public class LSTM_EntityMemNNMain_Mul {
	...
	public LSTM_EntityMemNNMain_Mul(String modelFile) throws Exception
	{
	...
	public LSTM_EntityMemNNMain_Mul() throws Exception
	{
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
			...
			LSTM_SentenceEntityMemNN_Mul memNN = new LSTM_SentenceEntityMemNN_Mul(
					wordIds,
					seedLookup,
					attentionCellSeed,
					entityTranformSeed,
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
	...
	public void dumpAttentionWeights(LSTM_SentenceEntityMemNN_Mul memNN,
	...
	public static void main(String[] args) throws Exception
	{
		...
		LSTM_EntityMemNNMain_Mul main = new LSTM_EntityMemNNMain_Mul();
...
//		String modelFile = "./target/classes/trainedModel/model-16-laptop-72.68-lstm.model";
