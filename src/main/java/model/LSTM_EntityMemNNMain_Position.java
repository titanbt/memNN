...
public class LSTM_EntityMemNNMain_Position {
	...
	public LSTM_EntityMemNNMain_Position(String modelFile) throws Exception
	{
	...
	public LSTM_EntityMemNNMain_Position() throws Exception
	{
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
	...
	public static void main(String[] args) throws Exception
	{
		...
		LSTM_EntityMemNNMain_Position main = new LSTM_EntityMemNNMain_Position();
