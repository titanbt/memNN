...
import nn.LSTM_SentenceEntityMemNN_SigmoidCell;
...
import nn.libs.combinedLayer.ConnectLinearSigmoid;
...
public class LSTM_EntityMemNNMain_SigmoidCell {

	LookupLayer seedLookup;
	ConnectLinearSigmoid attentionCellSeed;
	...
	public LSTM_EntityMemNNMain_SigmoidCell(String modelFile) throws Exception
	{
	...
	public LSTM_EntityMemNNMain_SigmoidCell() throws Exception
	{
		...
		attentionCellSeed = new ConnectLinearSigmoid(embeddingLength, embeddingLength, 1);
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
			...
			LSTM_SentenceEntityMemNN_SigmoidCell memNN = new LSTM_SentenceEntityMemNN_SigmoidCell(
					wordIds,
					seedLookup,
					attentionCellSeed,
					entityTranformSeed,
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
	...
	class TmpClass_{
		...
		ConnectLinearSigmoid _attentionCellSeed;
		...
		public TmpClass_(BufferedReader br) throws Exception
		{
			...
			_attentionCellSeed = ConnectLinearSigmoid.loadFromStream(br);
	...
	public void dumpAttentionWeights(LSTM_SentenceEntityMemNN_SigmoidCell memNN,
	...
	public static void main(String[] args) throws Exception
	{
		...
		LSTM_EntityMemNNMain_SigmoidCell main = new LSTM_EntityMemNNMain_SigmoidCell();
