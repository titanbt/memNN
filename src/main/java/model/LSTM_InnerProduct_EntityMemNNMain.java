...
import nn.LSTM_InnerProduct_SentenceEntityMemNN;
...
import nn.libs.combinedLayer.ConnectInnerProductSoftmaxLinearTanh;
import nn.libs.combinedLayer.SimplifiedLSTMLayer;

import java.io.*;
import java.util.*;

public class LSTM_InnerProduct_EntityMemNNMain {

	LookupLayer seedLookup;
	ConnectInnerProductSoftmaxLinearTanh attentionCellSeed;
	...
	public LSTM_InnerProduct_EntityMemNNMain(String modelFile) throws Exception
	{
	...
	public LSTM_InnerProduct_EntityMemNNMain() throws Exception
	{
		...
		attentionCellSeed = new ConnectInnerProductSoftmaxLinearTanh(embeddingLength, embeddingLength, 1);
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
			...
			LSTM_InnerProduct_SentenceEntityMemNN memNN = new LSTM_InnerProduct_SentenceEntityMemNN(
					wordIds,
					seedLookup,
					attentionCellSeed,
					entityTranformSeed,
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
	...
	class TmpClass_{
		...
		ConnectInnerProductSoftmaxLinearTanh _attentionCellSeed;
		...
		public TmpClass_(BufferedReader br) throws Exception
		{
			...
			_attentionCellSeed = ConnectInnerProductSoftmaxLinearTanh.loadFromStream(br);
	...
	public void dumpAttentionWeights(LSTM_InnerProduct_SentenceEntityMemNN memNN,
	...
	public static void main(String[] args) throws Exception
	{
		...
		LSTM_InnerProduct_EntityMemNNMain main = new LSTM_InnerProduct_EntityMemNNMain();
...
//		String modelFile = "./target/classes/trainedModel/model-26-laptop-lstm-7hops-73.31.model";
//		LSTM_InnerProduct_EntityMemNNMain main = new LSTM_InnerProduct_EntityMemNNMain(modelFile);
