...
public class TestLSTM_CNN_EntityMemNNMain {
	...
	public TestLSTM_CNN_EntityMemNNMain(String modelFile) throws Exception
	{
	...
	public TestLSTM_CNN_EntityMemNNMain() throws Exception
	{
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
	...
	public static void main(String[] args) throws Exception
	{
		...
		TestLSTM_CNN_EntityMemNNMain main = new TestLSTM_CNN_EntityMemNNMain();
		int roundNum = 200;
		double accuracy = 0.0;
		double bestAcc = 0.0;
